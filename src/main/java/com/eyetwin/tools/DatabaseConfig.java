...
public class DatabaseConfig {
    ...
    private DatabaseConfig() {
        try {
            ...
            e.printStackTrace();
            System.err.println(
                    "Assurez-vous que MySQL tourne sur le port 3306 et que la base 'eyetwin_platform' existe.");
        }
    }
    ...
    public Connection getCnx() {
        try {
            ...
            return null; // retour null pour que l'appelant sache que ça a échoué
        }
        return cnx;
    }
