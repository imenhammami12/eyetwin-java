...
/**
 * ComplaintRepository — version fusionnée (clean + robuste)
 */
public class ComplaintRepository {
    ...
    public List<Complaint> search(String keyword,
        ...
        if (keyword != null && !keyword.isBlank()) {
            sql.append("""
                AND (c.subject LIKE ? OR c.description LIKE ? OR u.username LIKE ?)
            """);
    ...
    public ComplaintStats getStatistics() throws SQLException {
        ...
        String sql = """
            SELECT
                ...
                SUM(c.priority IN ('URGENT','HIGH')) AS critical,
                SUM(c.sentiment_label='NEGATIVE') AS negative,
                SUM(c.sentiment_label='NEUTRAL') AS neutral,
                SUM(c.sentiment_label='POSITIVE') AS positive,
        ...
        try (Connection conn = DatabaseConfig.getConnection();
            ...
            if (rs.next()) {
                ...
                stats.setCritical(rs.getInt("critical"));
                stats.setNegative(rs.getInt("negative"));
                stats.setNeutral(rs.getInt("neutral"));
                stats.setPositive(rs.getInt("positive"));
    ...
    private Complaint mapRow(ResultSet rs) throws SQLException {
        ...
        c.setSentimentScore(rs.wasNull() ? null : score);
