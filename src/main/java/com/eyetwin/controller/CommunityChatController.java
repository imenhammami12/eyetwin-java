...
//
//    private Integer anchorMessageId = null;
//
//
//
...
//                            }
//
//                            boolean goToBottom = SocketEnvelope.TYPE_NEW_MESSAGE.equals(envelope.getType());
//                            Platform.runLater(() -> loadMessages(goToBottom));
//                        }
//
//                        @Override
...
//    }
//
//    private void loadMessages(boolean scrollToBottomAfterLoad) {
//        if (channel == null || messagesContainer == null) return;
//
//        double previousScroll = messagesScrollPane != null ? messagesScrollPane.getVvalue() : 1.0;
//
//        messagesContainer.getChildren().clear();
//
//        try {
